...
# delete an element
print("In a great battle, you lived to fight another day, "\
      "however your shield was destroyed")
del inventory[2]
print("Your inventory is now: ")
print(inventory)
input("\nPress the ENTER key to continue")
...
# delete a slice
print("You fell asleep. Your crossbow and armor were stolen by thieves.")
del inventory[:2]
print("Your inventory is now: ")
print(inventory)
input("\nPress the ENTER key to continue")
