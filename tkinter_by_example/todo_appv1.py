...
'''
A To Do application from the book "Tkinter By Example"
'''
...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        for task in self.tasks:
            task.pack(side=tk.TOP,
                      fill=tk.X)

        self.task_create = tk.Text(self,
                                   height=3,
                                   bg='white',
                                   fg='black')
        ...
        self.color_schemes = [{'bg': 'lightgrey',
                               'fg': 'black'},
                              {'bg': 'grey',
                               'fg': 'white'}]
    ...
    def add_task(self, event=None):
        ...
        if len(task_text) > 0:
            ...
            new_task.configure(bg=my_scheme_choice['fg'])
